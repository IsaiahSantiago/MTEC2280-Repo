...
//Broken Vibe code with usable variables??

// let serial;
// let latestData = 0; // Global variable for sensor data

// function setup() {
//   createCanvas(800, 600); // Max 1080x720, Min 400x400

//   // Serial port initialization (requires p5.serialcontrol)
//   serial = new p5.SerialPort();
//   serial.list();
//   serial.open('COM3'); // CHANGE TO YOUR PORT
...
//   latestData = int(currentString); // Store in global variable
// }

// function draw() {
//   // Use map() function to map input (0-1023) to different ranges
//   let bgColor = map(latestData, 0, 1023, 0, 255);
//   let circleSize = map(latestData, 0, 1023, 50, 400);
//   let rectColor = map(latestData, 0, 1023, 255, 0);
//   let posX = map(latestData, 0, 1023, 0, width);

//   // Use background()
//   background(bgColor, 100, 150);

//   // --- PRIMITIVE 1: Circle (Controlled by Size) ---
//   fill(255, rectColor, 100);
//   noStroke();
//   ellipse(width / 2, height / 2, circleSize, circleSize);

//   // --- PRIMITIVE 2: Rectangle (Controlled by Position) ---
//   fill(rectColor, 100, 255);
//   rect(posX - 50, height - 100, 100, 50);

//   // --- PRIMITIVE 3: Triangle (Controlled by Color/Intensity) ---
//   fill(0, 255, rectColor);
//   triangle(100, 100, 100, 100 + circleSize/4, 100 + circleSize/4, 100);
// // }
